(function exportI18n(root, factory) {
  ...
  const translations = {
    ru: {
      ...
      settings_open_button: 'Настройки',
      settings_title: 'Настройки',
      settings_close: 'Закрыть',
      settings_work_duration_label: 'Длительность работы',
      settings_break_duration_label: 'Длительность отдыха',
    ...
    uz: {
      ...
      settings_open_button: 'Sozlamalar',
      settings_title: 'Sozlamalar',
      settings_close: 'Yopish',
      settings_work_duration_label: 'Ish davomiyligi',
      settings_break_duration_label: 'Dam olish davomiyligi',
      duration_minutes: '{count} daqiqa',
